...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Download Planteome data')

    parser.add_argument('yaml_file', type=str,
            help='File with names to download')
    parser.add_argument('output_dir', type=str,
            help='Path to save the downloaded files')

    args = parser.parse_args()

    args.yaml_file = abspath(args.yaml_file)
    args.output_dir = abspath(args.output_dir)

    download_from_yaml(args.yaml_file, args.output_dir)
