...
class TestGetTokenizedDoc(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.one_sentence_one_word = {"doc_key":"PMID1_abstract",
                                      "dataset":"scierc",
                                      "sentences":[['hello']]}
        
        self.one_sentence_one_word_answer = ["hello"]

        self.one_sentence_multi_word = {"doc_key":"PMID2_abstract",
                                       "dataset":"scierc",
                                       "sentences":[['hello',"world","!"]]}
        
        self.one_sentence_multi_word_answer = ["hello","world","!"]

        self.multi_sentence_multi_word = {"doc_key":"PMID3_abstract",
                                         "dataset":"scierc",
                                         "sentences":[['hello',"world","!"],
                                                ["I","like","you","world","."]]}
        
        self.multi_sentence_multi_word_answer = ["hello","world","!","I",
                                                "like","you","world","."]
...
class TestGetTriples(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        # Make dicts 
        self.one_doc_no_triples = {"doc_key":"PMID1",
                                   "dataset":"scierc",
                                   "sentences":[["hello","world","!"]],
                                   "predicted_relations":[[]]}

        self.one_doc_one_triple =  {"doc_key":"PMID2",
                                    "dataset":"scierc",
                                    "sentences":[["hello","world","!"]],
                                    "predicted_relations":[[[0,0,1,1,"TO_THE",
                                                            0.89,1.45]]]}

        self.one_doc_multiple_triples = {"doc_key":"PMID3_abstract",
                                         "dataset":"scierc",
                                         "sentences":[['hello',"world","!"],
                                                ["I","like","you","world","."]],
                                         "predicted_relations":[[[0,0,1,1,"TO_THE",
        ...
        self.one_doc_compound_triples = {"doc_key":"PMID3_abstract",
                                         "dataset":"scierc",
                                         "sentences":[['hello',"world","!"],
                                                ["I","like","you","world","."]],
                                         "predicted_relations":[[[0,0,1,1,"TO_THE",
    ...
    def test_get_triples_multi_doc_mixed(self):
        ...
        """
        docs = [self.one_doc_no_triples, self.one_doc_one_triple,
...
class TestGetLooseEnts(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.no_overlap = {"doc_key":"PMID3_abstract",
                           "dataset":"scierc",
                           "sentences":[['hello',"world","!"],
                                        ["I","like","you","world","."]],
                           "predicted_ner":[[],[[4,4,"TYPE",0.345,1.345],
                                                [5,6,"TYPE2",0.43,1.34]]]}

        self.overlap = {"doc_key":"PMID4_abstract",
                        "dataset":"scierc",
                        "sentences":[['hello',"world","!"],
                                    ["I","like","you","world","."]],
...
class TestWriteDotFile(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.proper_DOT_no_ents = (f'strict digraph {self.graph_name} '
                            '{\nhello -> world\t[label="TO_THE",\n'
                            '\t\t\tweight=3];\nI -> "you world"\t[label="LIKE",\n'
                            '\t\t\tweight=1];\n}')
        self.proper_DOT_ents = (f'strict digraph {self.graph_name} '
                            '{\nhello -> world\t[label="TO_THE",\n'
                            '\t\t\tweight=3];\nI -> "you world"\t[label="LIKE",\n'
                            '\t\t\tweight=1];\nyou;\n}')
